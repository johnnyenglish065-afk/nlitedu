  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col font-sans">
      <style dangerouslySetInnerHTML={{ __html: `
        /* Hide LiveKit's default built-in chat window to fix the dual chat issue */
        .lk-chat { display: none !important; }
        .lk-button.lk-chat-toggle { display: none !important; }
      `}} />

      {/* Header */}
      <header className="bg-slate-900 border-b border-slate-800 p-4 flex justify-between items-center z-10 shadow-lg relative">
