...
const WorkshopEnrollmentPageContent = () => {
  ...
  const saveFormToLocal = (formData: any, fee: number, mrp: number) => {
    if (typeof window !== "undefined") {
      localStorage.setItem("pending_workshop_enrollment", JSON.stringify({ ...formData, _fee: fee, _mrp: mrp }));
    }
  };
    ...
    try {
      ...
      if (activeGateway === "razorpay") {
        ...
        cashfree.checkout({
          ...
          returnUrl: `${window.location.origin}/workshop/enroll?order_id=${orderId}`
        });
      }
        ...
        <div className="p-8 pt-10 text-center">
          ...
          <div id="receipt-actions" className="grid gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href="https://github.com/saveragraphics/NLITedu-Mobile/releases/download/v1.0.14+21/app-release.apk"
                download
